...
const Monthly_Pricing = () => {
  return (
    <div>
      ...
      <div className="border-slate-300 border-[3px] rounded-3xl shadow-2xl flex p-4 m-10 justify-center items-center w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/4  hover:border-[#3580f0] duration-500">
          <div className="mt-8">
            <div className=" flex  ">
              <Image
        ...
        <div className="border-slate-300 border-[3px] rounded-3xl shadow-2xl flex p-4 m-10 justify-center items-center w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/4  hover:border-[#3580f0] duration-500">
          ...
          <div className="flex justify-end">
            ...
            <div className="mt-16 m-10  text-center">
              <h3 className="">
                <sup className="text-5xl   font-bold">&#8377; 499</sup>
              </h3>
            </div>
        ...
        <div className="border-slate-300 border-[3px]  rounded-3xl shadow-2xl flex p-4 m-10 justify-center items-center w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/4  hover:border-[#3580f0] duration-500 ">
          <div className="mt-7">
            ...
            <div className="mt-16 m-6  text-center">
              <h3 className="">
                <sup className="text-5xl   font-bold">&#8377; 999</sup>
              </h3>
            </div>
            <div className="flex justify-center mt-10 m-6">
              <button className="btn btn border rounded-full p-3 w-[145px] h-[46px] p-[8px 35px] rounded-[44px] hover:bg-[#3580f0] ">
...
export default Monthly_Pricing;
