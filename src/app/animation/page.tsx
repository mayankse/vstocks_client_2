...
const AnimationPage = () => {
  return (
    ...
    //     <HeaderPage />
    //   </div>
    //   <div className="bg-[#f8f4f9] md:m-10 p-4">
    //     <div className="md:m-4">
    //       <div className="flex flex-col md:flex-row justify-around md:m-4 mt-4">
    //         <div className="md:mb-0 mt-4 flex justify-center items-center">
    //           <p className="inline-block mx-text sm:text-[20px] font-popinns font-medium md:text-[30px] lg:text-[40px] xl:text-[18px]">
    //             My Project
    //           </p>
    //           <KeyboardArrowRight className="hidden xl:flex" />
    //         </div>
    ...
    //               className="w-full p-2 md:p-4 lg:py-4 pr-10 rounded-full inline-block placeholder-text-[#6e6c6e] placeholder-font-roman placeholder-ml-4 placeholder-text-18px bg-[#efebf0] focus:outline-none"
    //             />
    //             <span className="absolute inset-y-0 right-0 flex items-center pr-3">
    //               <Search className="w-6 h-6 md:w-[16px] md:h-[16px] text-[#6e6c6e]" />
    //             </span>
    //           </div>
    //         </div>
    //         <div className=" mt-4  hidden xl:flex ">
    //           <p className="xl:inline-block text-[18px] font-popinns font-medium ">
    //             View All
    //           </p>
    //           <KeyboardArrowDown />
    //         </div>
    //       </div>
    //       <div className="flex flex-col mt-5 justify-around xl:mt-[105px] md:flex-row md:m-4">
    //         <div className="shadow-md rounded-lg bg-[] md:w-1/3 lg:w-1/4">
    ...
    //               <div className="ml-5 xl:mt-5 text-md inline-block font-medium">
    //                 unitold file 1
    //               </div>
    ...
    //               <div className="inline-block font-medium mt-[-10px]">
    //                 Sankranti
    //               </div>
    //               <div className="inline-block">
    ...
    //             />
    //             <div className="justify-between ml-8">
    //               <div className="inline-block font-medium mt-[0px]">
    //                 unitold file 1
    //               </div>
    //               <div className="inline-block">
    //                 <Edit className="ml-10" />
    ...
    //         <div className="shadow-md rounded-lg h-[290px] md:w-1/3 lg:w-1/4">
          ...
          <div className="flex flex-col md:flex-row justify-around md:m-4 mt-3">
            <div className="md:mb-0 mt-1 flex justify-center items-center">
              <p className="inline-block mx-text sm:text-[22px] font-popinns font-semibold md:text-[30px] lg:text-[40px] xl:text-[24px]">
                My Projects &nbsp;{" "}
                <KeyboardArrowRight className=" sm:relative absolute  xl:text-3xl xl:flex" />
              </p>
            </div>
            <div className="w-full md:w-3/4 lg:w-1/2 mt-4 md:mt-0 hidden xl:flex">
